...
| `PROGRAM_ID` | `chain-reader.service.ts`, `helius-parser.service.ts` | Program PDA — `3YpkUKBh8288XN2dCKSwBnEdyc5UozSJ19A1ZCLpUZsZ` for devnet (the new Codama-era address; the legacy `AuXJKpu...` deploy is no longer canonical) |
