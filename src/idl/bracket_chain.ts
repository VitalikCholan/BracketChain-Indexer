...
export type BracketChain = {
  ...
  instructions: [
    {
      ...
      discriminator: [249, 227, 133, 5, 9, 142, 29, 122];
      accounts: [
        {
          name: 'caller';
          docs: [
    ...
    {
      name: 'reportResult';
      discriminator: [195, 187, 161, 107, 75, 154, 102, 183];
      accounts: [
        {
          name: 'organizer';
          writable: true;
    ...
    },
    {
      ...
      discriminator: [164, 168, 208, 157, 43, 10, 220, 241];
      accounts: [
        {
          name: 'organizer';
          writable: true;
  ...
  accounts: [
    {
      name: 'matchNode';
      discriminator: [177, 131, 32, 203, 23, 107, 237, 191];
    },
    {
      name: 'participant';
  ...
  events: [
    {
      name: 'matchReported';
      discriminator: [213, 163, 144, 194, 233, 124, 25, 37];
    },
    {
      name: 'participantRegistered';
      discriminator: [47, 115, 159, 109, 135, 121, 70, 193];
    },
    {
      name: 'refundIssued';
    ...
    },
    {
      ...
      discriminator: [118, 92, 146, 131, 165, 72, 81, 120];
    },
    {
      name: 'tournamentCompleted';
      discriminator: [67, 47, 75, 4, 191, 61, 1, 150];
    },
    {
    ...
    },
    {
      ...
      discriminator: [200, 157, 174, 194, 174, 219, 107, 44];
    },
  ];
  errors: [
    {
